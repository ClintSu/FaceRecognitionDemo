...
namespace ArcFace
{
    ...
    public static class Api
    {
        ...
        /// <param name="maxFaceNumber">用户期望引擎最多能检测出的人脸数有效值范围[1,500]</param>
        ...
        public static bool Init(out string message, string appId, string dKey, string rKey, int scale = 50, int maxFaceNumber = 10, string faceDataPath = "d:\\FeatureData")
        {
            ...
            if (maxFaceNumber < 1 || maxFaceNumber > 500)
            {
                message = "人脸数量必须在1-500之间";
                return false;
            }
        ...
        public static bool FaceMatch(Bitmap bitmap)
        {
            try
            {
